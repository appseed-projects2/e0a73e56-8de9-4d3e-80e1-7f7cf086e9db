...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-30 18:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e0a73e56-8de9-4d3e-80e1-7f7cf086e9db.git
$ cd e0a73e56-8de9-4d3e-80e1-7f7cf086e9db
```
